  ...
  try {
    ...
    if (totalHits === 0) {
      ...
      return Notiflix.Notify.failure(
        'Sorry. We assume, that all the pictures at your request were stolen by мuscovites. Please make another request, perhaps not everything has been stolen by muscovites.'
      );
